...
struct Animation LINK_WALKING_SOUTH = {NULL, 10, 32, 32, 0,
	"resources/link_walking_south.png"};
struct Animation LINK_WALKING_NORTH = {NULL, 10, 32, 32, 0,
	"resources/link_walking_north.png"};
struct Animation LINK_WALKING_WEST = {NULL, 10, 32, 32, 0,
	"resources/link_walking_west.png"};
struct Animation LINK_WALKING_EAST = {NULL, 10, 32, 32, 0,
	"resources/link_walking_east.png"};
struct Animation LINK_IDLE_SOUTH = {NULL, 1, 32, 32, 0,
	"resources/link_idle_south.png"};
struct Animation LINK_IDLE_NORTH = {NULL, 1, 32, 32, 0,
	"resources/link_idle_north.png"};
struct Animation LINK_IDLE_WEST = {NULL, 1, 32, 32, 0,
	"resources/link_idle_west.png"};
struct Animation LINK_IDLE_EAST = {NULL, 1, 32, 32, 0,
